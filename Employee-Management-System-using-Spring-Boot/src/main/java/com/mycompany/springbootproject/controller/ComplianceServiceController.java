...
public class ComplianceServiceController {
    ...
    @ApiOperation("Save a New Compliance Record.") // annotation to describe the endpoint and its response type
    ...
    @ApiOperation("Save a New Compliance Record.") // annotation to describe the endpoint and its response type
    @PostMapping("/create/status") // // Annotation for mapping HTTP POST requests onto specific handler methods.
