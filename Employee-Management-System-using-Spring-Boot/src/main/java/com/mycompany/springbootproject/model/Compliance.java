...
public class Compliance {
    ...
    @Size(min = 2, max = 20) // specifies range of the variable
    @NotNull(message = "Enter Details") // does not permit to pass a null value
    private String details;

    @NotNull(message = "Enter Date of creation") // does not permit to pass a null value
    ...
    @NotNull(message = "Enter employee count") // does not permit to pass a null value
    private int empCount;

    @NotNull(message = "Enter Status Count") // does not permit to pass a null value
    private int stsCount;

    @NotNull(message = "Enter Status") // does not permit to pass a null value
